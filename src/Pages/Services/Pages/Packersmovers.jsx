...
<img src={rightarrow} alt="rightarrow" style={{ width: '30px', height: '30px' }} />
                    ...
                    <div className="detail">
                        <a href="/ListingResults/Advocates-Lawyers-Service/tc">Local Packers & Movers</a>
...
<img src={rightarrow} alt="rightarrow" style={{ width: '30px', height: '30px' }} />
                    ...
                    <div className="detail">
                        <a href="/ListingResults/Advocates-Lawyers-Service/tc" >National Packers & Movers</a>
...
<img src={rightarrow} alt="rightarrow" style={{ width: '30px', height: '30px' }} />
                    ...
                    <div className="detail">
                        <a href="/ListingResults/Advocates-Lawyers-Service/tc" >International Packers & Movers</a>
