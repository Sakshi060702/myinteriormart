        ...
        <div className="row justify-content-center categories-list border-box" >
            <div className="col-lg-3 col-6">
                <div className="item">
                    ...
                    <div className="detail">
                        <a href="/ListingResults/Advocates-Lawyers-Service/tc">Property For Buy</a>
            ...
            <div className="col-lg-3 col-6">
                <div className="item">
                    ...
                    <div className="detail">
                        <a href="/ListingResults/Advocates-Lawyers-Service/tc" >Property For Sale</a>
            ...
            <div className="col-lg-3 col-6">
                <div className="item">
                    ...
                    <div className="detail">
                        <a href="/ListingResults/Advocates-Lawyers-Service/tc" >Property For Rent</a>
