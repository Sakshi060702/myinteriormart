...
<img src={rightarrow} alt="rightarrow" style={{ width: '30px', height: '30px' }} />
                    ...
                    <div className="detail">
                        <a href="/ListingResults/Advocates-Lawyers-Service/tc">Water Tank</a>
...
<img src={rightarrow} alt="rightarrow" style={{ width: '30px', height: '30px' }} />
                    ...
                    <div className="detail">
                        <a href="/ListingResults/Advocates-Lawyers-Service/tc" >Oil Tank</a>
...
<img src={rightarrow} alt="rightarrow" style={{ width: '30px', height: '30px' }} />
                    ...
                    <div className="detail">
                        <a href="/ListingResults/Advocates-Lawyers-Service/tc" >Chemical Tank</a>
