...
function Addspecialisationdetails()
{
    return(
   ...
   <h4>Add Specialisations Details</h4>
    ...
    <div className="row">
        ...
        <div className="col-md-3">
            <div className="clearfix add_bottom_15">
                <div className="checkboxes float-left">
                    <label className="container_check">Hotels
    ...
    <div className="row">
        <div className="text-left col-12 mt-3">
                    <Link to="/Categorydetails" className="btn_1 mx-2">Back</Link>
                    <Link to="/Uploadimg" className="btn_1 ">Save & Continue</Link>
        </div>
    </div>
        </div>
...
export default Addspecialisationdetails;