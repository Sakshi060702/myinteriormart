         ...
         <div className="col-lg-3 individual-listing-sidebar padding-5">
            <div className="listing-specialisat box_detail_cus">
                ...
                <ul className="listing-specialisat-list">
                    <li><i className="icon-check-1"></i> Service 1</li>
                    <li><i className="icon-check-1"></i> Service 2</li>
                    <li><i className="icon-check-1"></i> Service 3</li>
                    <li><i className="icon-check-1"></i> Service 4</li>
                </ul>
            </div>
            <div className="listing-specialisat box_detail_cus">
                <h6>Specialisation</h6>
                <ul className="listing-specialisat-list">
                    <li><i className="icon-check-1"></i> Bank</li>
                    <li><i className="icon-check-1"></i> Exhibition Stall</li>
            ...
            <div className="listing-specialisat box_detail_cus">
                ...
                <ul className="listing-specialisat-list">
                    <li><i className="icon-check-1"></i> Cash</li>
                    <li><i className="icon-check-1"></i> Net Banking</li>
...
export default Labournakaservices