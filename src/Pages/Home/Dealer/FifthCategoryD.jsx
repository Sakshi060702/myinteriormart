                ...
                {fifthCategory.sixthCategories &&
                  fifthCategory.sixthCategories.length > 0 && (
                    ...
                    to={`/${fifthCategory.name
                      .replace(/\s+/g, "-")
                      .toLowerCase()}/${fourthCategoryName}/${subcategoryName}/${secondCategoryName}/Dealer/in-${localStorage.getItem('cityname')}?fcatEncyt=${encodeURIComponent(encrypt(parseInt(fifthCategory.fifthCategoryID)))}`}
                      title={fifthCategory.name}
                      style={{ color: "orange" }}
                    >
                       more ...
