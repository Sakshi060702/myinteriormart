...
function SixthCategoryListing() {
  const { secondCategoryId ,secondCategoryName,subcategoryName,fourthCategoryName,sixthCategoryName} = useParams();
  ...
  useEffect(() => {
    fetchListings();
  }, [secondCategoryId, currentPage,secondCategoryName,subcategoryName,fourthCategoryName,sixthCategoryName]);
...
export default SixthCategoryListing;
