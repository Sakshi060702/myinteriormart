      ...
      {isOpen && (
        <div className="popup2-overlay" onClick={onClose}>
          <div className="popup2-content" onClick={(e) => e.stopPropagation()}>
            ...
            <h3 className="success-message" style={{ textAlign: 'center',color:'orange' }}>Thank You</h3>
           ...
           <div className="popupbutton-container paymentgatewaypopup">
              <button onClick={handleContinue} style={{color:"white",fontSize:'18px'}}>Home</button>
              
            </div>
            <div className="popupbutton-container paymentgatewaypopup">
              <button onClick={handlelisting} style={{color:"white",fontSize:'18px'}}>Go to Listing</button>
