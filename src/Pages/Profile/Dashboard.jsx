        ...
        <div className="add-review">
          ...
          <div className="row">
            <div className="col-md-4 col-6 mb-3">
              <Link to={`/AllBookmark/${localStorage.getItem('cityname')}`}>
            ...
            <div className="col-md-4 col-6 mb-3">
              <Link to={`/AllLike/${localStorage.getItem('cityname')}`}>
                <div className="add_listing_card d-flex align-items-center justify-content-start">
            ...
            <div className="col-md-4 col-6 mb-3">
              <Link to={`/AllReviews/${localStorage.getItem('cityname')}`}>
                <div className="add_listing_card d-flex align-items-center justify-content-start">
            ...
            <div className="col-md-4 col-6 mb-3">
              <Link to={`/AllSubscribe/${localStorage.getItem('cityname')}`}>
                <div className="add_listing_card d-flex align-items-center justify-content-start">
